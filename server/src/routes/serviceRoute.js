...
import  { getServices, createService, deleteService, updateService, categoryWithServices } from "../controllers/serviceController.js";
...
router.route('/admin/:showDisabled?').get(passport.authenticate('jwt', {session: false}),getServices);
